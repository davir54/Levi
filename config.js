...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO LEVI-BOT COM 363 COMANDOS, BATERIA: ${battery}`
}
...
const blockedmsg = '*Quem e você? Seu número esta bloqueado, ou seja não ouvindo você 😜*'
...
const botgay = 'Falou o manja rola, seu corno😡'
